...
\begin{enumerate}
	...
	\begin{compactitem}
		\item[\textbf{a}] $(x,(s,e,a)) \Rightarrow (s(x), (s,e,a))\text{, falls }s(x) \neq \text{\underline{frei}}$ für $\times \in$JD, $(s,e,a) \in \mathcal{Z}$
...
$\underline{eval}(P)(E)=\left\lbrace\begin{array}{l l} A\text{,}&\text{falls } (P,(S_0,E,\mathcal{E}))\xRightarrow{*}(\underline{skip},(S,E',A))\text{ mit bel. } S \in \phi \text{ und } E', A \in \text{KON}^*\\
