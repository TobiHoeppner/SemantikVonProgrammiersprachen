...
\marginnote{\small\emph{(formales Setting von logischen Ausdrücken vorgeben, damit man damit arbeiten kann!)}}[2,5cm]
% höhe Formel A.1
\marginnote{\small\emph{(zu lesen: Für jede Bedingung $Q$ gilt die Hoare-Formel $\{Q\}\underline{skip}\{Q\}$)}}[8,5cm]
...
\begin{compactitem}
	...
	Beispiel: $x < y, input = \epsilon$\\ %TODO es gibt ein(existenzquantor) i.x=p.i, ...
...
\end{compactitem}
\subsubsection{Konkretisierung am Beispiel von WHILE'}
%TODO als Einschub:
\begin{align*}
